<table style="font-family:Arial, Helvetica, sans-serif;
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid #e0e0e0; padding: 7px 17px;">{{ $mobile }}</td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid #e0e0e0; border-right: 1px solid #e0e0e0; background: #fafafa;  padding: 7px 17px;">Email</td>
        <td style="border-bottom: 1px solid #e0e0e0; background: #fafafa;  padding: 7px 17px;">{{ $email }}</td>
    </tr>
    <tr>
        <td style="border-bottom: 1px solid #e0e0e0; border-right: 1px solid #e0e0e0; background: #fafafa;  padding: 7px 17px;">Повідомлення</td>
